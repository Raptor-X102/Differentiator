...
void TeX_introduction(FILE* output_file) {
    ...
    TEX_PRINTF("\\usepackage[colorlinks=true, urlcolor=blue, linkcolor=blue, citecolor=blue]{hyperref}\n");
    ...
    TEX_PRINTF("\\date{}\n");
    TEX_PRINTF("\\author{\\text{Raptor-X102}}\n\n");
    ...
    TEX_PRINTF("GitHub: \\href{https://github.com/Raptor-X102}{https://github.com/Raptor-X102}\\\\");
